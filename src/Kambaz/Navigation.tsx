...
import { BsArrowBarRight, BsCalendar3, BsClock, BsFillInboxFill, BsPcDisplayHorizontal, BsQuestionCircle } from "react-icons/bs";
 ...
 return (
  <ListGroup id="wd-kambaz-navigation" style={{ width: 120 }} 
    ...
    <ListGroup.Item to="/Kambaz/Dashboard" as={Link}
       ...
       className="text-white
                  bg-black text-center border-0">
       <BsCalendar3 className="fs-1 text-danger" /><br />
       Calendar </ListGroup.Item>
       <ListGroup.Item to="/Kambaz/Dashboard" as={Link}
       className="text-white
                  bg-black text-center border-0">
       <BsFillInboxFill className="fs-1 text-danger" /><br />
       Inbox </ListGroup.Item>
       <ListGroup.Item to="/Kambaz/Dashboard" as={Link}
       className="text-white
                  bg-black text-center border-0">
       <BsClock className="fs-1 text-danger" /><br />
       History </ListGroup.Item>
       <ListGroup.Item to="/Kambaz/Dashboard" as={Link}
       className="text-white
                  bg-black text-center border-0">
       <BsPcDisplayHorizontal className="fs-1 text-danger" /><br />
       Studio </ListGroup.Item>
       <ListGroup.Item to="/Kambaz/Dashboard" as={Link}
       className="text-white
                  bg-black text-center border-0">
       <BsArrowBarRight className="fs-1 text-danger" /><br />
       Commons </ListGroup.Item>
       <ListGroup.Item to="/Kambaz/Dashboard" as={Link}
       className="text-white
                  bg-black text-center border-0">
